  ...
  async function handleCreate(values) {
    try {
      ...
      setFeedback({
        severity: "error",
        message:
          error.message || "No pudimos crear el hábito. Intenta nuevamente.",
      });
    }
  }
    ...
    >
      <Box>
        ...
        <Typography color="text.secondary" sx={{ mt: 0.5 }}>
          Define los detalles para comenzar a darle seguimiento.
        </Typography>
      </Box>
      ...
      <Card>
        ...
        >
          <HabitForm
            cancelHref="/habits"
            initialValues={emptyHabitValues}
            isEditing={false}
            onSubmit={handleCreate}
            submitLabel="Guardar hábito"
          />
        </CardContent>
      </Card>
